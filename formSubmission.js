...
// const submitBtn = document.querySelector(".touch .form form .button button");
// console.log(submitBtn.textContent);
// const inputField = document.querySelectorAll(
//   ".touch .form form .details div input"
// );
...
const surname = document.querySelector(
  ".touch div form .form-id div .surname"
);
...
const formValidation = (e) => {
  ...
  surname.value === ""
    ...
    : (surnameSpan.style.display = "none",(surname.style.border = "1px solid green"));
  emailAddress.value === ""
    ? ((emailAddressSpan.style.display = "block"),
      (emailAddress.style.border = "1px solid red"))
    : (emailAddressSpan.style.display = "none",(emailAddress.style.border = "1px solid green"));
  mobileNumber.value === ""
    ? ((mobileNumberSpan.style.display = "block")
      (mobileNumber.style.border = "1px solid red"))
    : (mobileNumberSpan.style.display = "none"),(mobileNumber.style.border = "1px solid green");
